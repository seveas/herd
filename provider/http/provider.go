...
func (p *HttpProvider) Fetch(ctx context.Context, mc chan katyusha.CacheMessage) ([]byte, error) {
...
func (p *HttpProvider) Load(ctx context.Context, mc chan katyusha.CacheMessage) (katyusha.Hosts, error) {
