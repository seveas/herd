...
const (
	...
	KatyushaParserT__1        = 2
	KatyushaParserT__2        = 3
	KatyushaParserT__3        = 4
	KatyushaParserT__4        = 5
	KatyushaParserRUN         = 6
	KatyushaParserSB_OPEN     = 7
	KatyushaParserCB_OPEN     = 8
	KatyushaParserSET         = 9
	KatyushaParserADD         = 10
	KatyushaParserREMOVE      = 11
	KatyushaParserLIST        = 12
	KatyushaParserHOSTS       = 13
	KatyushaParserDURATION    = 14
	KatyushaParserNUMBER      = 15
	KatyushaParserIDENTIFIER  = 16
	KatyushaParserGLOB        = 17
	KatyushaParserEQUALS      = 18
	KatyushaParserMATCHES     = 19
	KatyushaParserNOT_EQUALS  = 20
	KatyushaParserNOT_MATCHES = 21
	KatyushaParserSTRING      = 22
	KatyushaParserREGEXP      = 23
	KatyushaParserSKIP_       = 24
)
...
const (
	...
	KatyushaParserRULE_scalar = 8
	KatyushaParserRULE_value  = 9
	KatyushaParserRULE_array  = 10
	KatyushaParserRULE_hash   = 11
)
	...
	case 1:
		{
			...
			if !(_la == KatyushaParserIDENTIFIER || _la == KatyushaParserGLOB) {
...
func (s *FilterContext) NOT_EQUALS() antlr.TerminalNode {
	return s.GetToken(KatyushaParserNOT_EQUALS, 0)
}
...
func (s *FilterContext) NOT_MATCHES() antlr.TerminalNode {
	return s.GetToken(KatyushaParserNOT_MATCHES, 0)
}
	...
	case KatyushaParserEQUALS, KatyushaParserNOT_EQUALS:
		{
			...
			if !(_la == KatyushaParserEQUALS || _la == KatyushaParserNOT_EQUALS) {
				var _ri = p.GetErrorHandler().RecoverInline(p)
	...
	case KatyushaParserMATCHES, KatyushaParserNOT_MATCHES:
		{
			...
			if !(_la == KatyushaParserMATCHES || _la == KatyushaParserNOT_MATCHES) {
				var _ri = p.GetErrorHandler().RecoverInline(p)
...
func NewEmptyScalarContext() *ScalarContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = KatyushaParserRULE_scalar
	return p
}
...
func (p *KatyushaParser) Scalar() (localctx IScalarContext) {
	localctx = NewScalarContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 16, KatyushaParserRULE_scalar)
	var _la int
...
func (p *KatyushaParser) Value() (localctx IValueContext) {
	...
	p.EnterRule(localctx, 18, KatyushaParserRULE_value)
...
func NewEmptyArrayContext() *ArrayContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = KatyushaParserRULE_array
	return p
}
...
func (s *ArrayContext) SB_OPEN() antlr.TerminalNode {
	return s.GetToken(KatyushaParserSB_OPEN, 0)
}
...
func (p *KatyushaParser) Array() (localctx IArrayContext) {
	localctx = NewArrayContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 20, KatyushaParserRULE_array)
	var _la int
...
func NewEmptyHashContext() *HashContext {
	...
	p.BaseParserRuleContext = antlr.NewBaseParserRuleContext(nil, -1)
	p.RuleIndex = KatyushaParserRULE_hash
	return p
}
...
func (s *HashContext) CB_OPEN() antlr.TerminalNode {
	return s.GetToken(KatyushaParserCB_OPEN, 0)
}

func (s *HashContext) AllIDENTIFIER() []antlr.TerminalNode {
	return s.GetTokens(KatyushaParserIDENTIFIER)
}

func (s *HashContext) IDENTIFIER(i int) antlr.TerminalNode {
	return s.GetToken(KatyushaParserIDENTIFIER, i)
}
...
func (p *KatyushaParser) Hash() (localctx IHashContext) {
	localctx = NewHashContext(p, p.GetParserRuleContext(), p.GetState())
	p.EnterRule(localctx, 22, KatyushaParserRULE_hash)
	var _la int
