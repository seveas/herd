...
func TestParseCommandLine(t *testing.T) {
	tests := []struct {
		...
		{
			spec: []string{"*"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{}, sampled: []string{}}},
			err:  "",
		},
		{
			spec: []string{"+", "*"},
		...
		{
			spec: []string{"*", "foo=bar"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{{Name: "foo", Value: "bar", FuzzyTyping: true}}, sampled: []string{}}},
			err:  "",
		},
		{
			spec: []string{"*", "foo=bar", "baz=quux"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{{Name: "foo", Value: "bar", FuzzyTyping: true}, {Name: "baz", Value: "quux", FuzzyTyping: true}}, sampled: []string{}}},
			err:  "",
		},
		{
			spec: []string{"*", "foo=bar", "+", "*", "baz=quux"},
		...
		{
			spec: []string{"*", "foo!=bar"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{{Name: "foo", Value: "bar", FuzzyTyping: true, Negate: true}}, sampled: []string{}}},
			err:  "",
		},
		{
			spec: []string{"*", "foo=~bar"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{{Name: "foo", Value: regexp.MustCompile("bar"), Regex: true}}, sampled: []string{}}},
			err:  "",
		},
		{
			spec: []string{"*", "foo!~bar"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{{Name: "foo", Value: regexp.MustCompile("bar"), Regex: true, Negate: true}}, sampled: []string{}}},
			err:  "",
		},
		{
			spec: []string{"foo=bar"},
		...
		{
			spec: []string{"foo:1"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{}, sampled: []string{"foo"}, count: 1}},
			err:  "",
		},
		{
			spec: []string{"foo:bar:1"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{}, sampled: []string{"foo", "bar"}, count: 1}},
			err:  "",
		},
		{
			spec: []string{":::foo:bar::baz:::quux:3"},
			cmd:  []command{addHostsCommand{glob: "*", attributes: katyusha.MatchAttributes{}, sampled: []string{"foo", "bar:baz:", "quux"}, count: 3}},
			err:  "",
		},
		{
