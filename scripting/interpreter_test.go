...
var testcases = []testcase{
	...
	},
	{
		...
		commands: []command{
			...
			listHostsCommand{opts: katyusha.HostListOptions{Separator: ",", Header: true, Align: true}},
			runCommand{command: "find / -name 'whatever' -delete"},
			listHostsCommand{opts: katyusha.HostListOptions{Separator: "-", OneLine: true, AllAttributes: true, Attributes: []string{"foo"}, Csv: true}},
		},
	},
	{
	...
	},
	{
		...
		commands: []command{
			...
			setCommand{variable: "Output", value: katyusha.OutputInline},
		},
	},
	{
