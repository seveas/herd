...
test_expect_success "We see hosts using the consul provider" "
    ...
    echo 'dc1          6    ' >> expected &&
    echo 'dc2          6    ' >> expected &&
    katyusha list --refresh katyusha_provider=consul --count datacenter --sort datacenter > actual &&
...
test_expect_success "We see services using the consul provider" "
    ...
    katyusha list katyusha_provider=consul --count service --sort service > actual &&
    test_cmp expected actual
"
