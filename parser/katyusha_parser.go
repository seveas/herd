...
const (
	...
	KatyushaParserNUMBER     = 6
	KatyushaParserIDENTIFIER = 7
	KatyushaParserGLOB       = 8
	KatyushaParserEQUALS     = 9
	KatyushaParserSTRING     = 10
	KatyushaParserSKIP_      = 11
)
...
func (p *KatyushaParser) Value() (localctx IValueContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == KatyushaParserNUMBER || _la == KatyushaParserSTRING) {
